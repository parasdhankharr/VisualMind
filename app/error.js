...
export default function GlobalError({ error, reset }) {
  ...
  return (
    <main className="min-h-screen bg-midnight px-4 py-8 text-white sm:px-8 relative grid place-items-center">
      <div className="fixed inset-0 bg-hero-grid bg-[length:42px_42px] opacity-25 pointer-events-none" />
      <section className="relative glass glow-ring rounded-[2rem] p-8 text-center max-w-3xl">
